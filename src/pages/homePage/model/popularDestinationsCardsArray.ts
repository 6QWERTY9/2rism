...
export const popularDestinationsCardArray: CardProps[] = [
    ...
    {img: '/cards_img/popularDestinations_img/2.png', title: 'Prescott', location: 'Arizona, USA'},
    {img: '/cards_img/popularDestinations_img/3.png', title: 'Fort Mayers', location: 'Florida, USA'},
